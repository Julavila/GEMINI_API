...
Si te hacen una pregunta que no está realicionada con la Inteligencia Artificial, responde 'Lo siento, solo puedo responder preguntas relacionadas con la Inteligencia Artificial. """
)
